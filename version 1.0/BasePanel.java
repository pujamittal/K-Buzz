    ...
    */
    public BasePanel(String[] jpg) {
       ...
       //now I create the radio buttons
        JRadioButton ans1 = new JRadioButton(jpg[0]);
        ans1.setMnemonic(KeyEvent.VK_A);
        ans1.setActionCommand(jpg[0]);
        ans1.setSelected(true);
 
        JRadioButton ans2 = new JRadioButton(jpg[1]);
        ans2.setMnemonic(KeyEvent.VK_B);
        ans2.setActionCommand(jpg[1]);
        
        JRadioButton ans3 = new JRadioButton(jpg[2]);
        ans3.setMnemonic(KeyEvent.VK_C);
        ans3.setActionCommand(jpg[2]);
        
        JRadioButton ans4 = new JRadioButton(jpg[3]);
        ans3.setMnemonic(KeyEvent.VK_D);
        ans4.setActionCommand(jpg[3]);
        ans4.setSelected(true);
 
        JRadioButton ans5 = new JRadioButton(jpg[4]);
        ans5.setMnemonic(KeyEvent.VK_E);
        ans5.setActionCommand(jpg[4]);
        ...
        //the default image is the jpg[0] template
        question = new JLabel(createImageIcon(jpg[6] + ".jpg"));
        question.setPreferredSize(new Dimension(400, 100));
        response = new JLabel(createImageIcon(jpg[0]));
     ...
     * no return
     * if the button selected is the "jpg[0]" button, sets button recorder to "jpg[0]"
     * else if the button selected is the "jpg[1]" button, sets button recorder to "medium skin"
     * else if the button selected is the "jpg[2]" button, sets button recorder to "dark skin"
     */ 
    ...
    public void displaywindow(String[] jpg){
        
        //frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        JComponent newContentPane = new BasePanel(jpg);
